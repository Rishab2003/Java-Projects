...
<body>
<% response.setHeader("Cache-Control","r-cache,no-store"); %>
			...
			<div class="container">
				<div class="signup-content">
					...
					<div class="signup-image">
						...
						<a href="login.jsp" class="signup-image-link">Go back to Login</a>
					</div>
				</div>
			</div>
		</section>
	...
	<!-- No idea how this works. Used for popup message -->
	...
	<link rel="stylesheet"href="alert/dist/sweetalert.css">
	  <script type = "text/javascript">  
            ...
            if(status=="invalidname"){
            	swal("Failure","Enter Name","error");
            }
            if(status=="invalidemail"){
            	swal("Failure","Enter Email","error");
            }
            if(status=="invalidpass"){
            	swal("Failure","Enter Password","error");
            }
            if(status=="invalidcontact"){
            	swal("Failure","Enter Contact number","error");
            }
            if(status=="passnotmatch"){
            	swal("Failure","Password does not match","info");
            }
